...
net = NeuralNet(
    ...
    dropout1_p=0.2,
    conv2_num_filters=352, conv2_filter_size=(4, 4), pool2_ds=(2, 2),
    dropout2_p=0.2,
    conv3_num_filters=800, conv3_filter_size=(3, 3), pool3_ds=(2, 2),
    dropout3_p=0.2,
    conv4_num_filters=1408, conv4_filter_size=(2, 2), pool4_ds=(2, 2),
    dropout4_p=0.2,
